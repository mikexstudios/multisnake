  ...
  private class SnakeUpdater extends TimerTask {
    ...
    private void stepSnakes() {
      synchronized (snakes) {
        ...
        // Create map from position to list of snakes trying to move into this position.  Snake of maximum length
        // survives.  If there is a tie for longest, every snake in the list dies.
        // A directed graph of killings is constructed.  Each snake has a set of snakes which it has killed during
        // this step.
        // At the end, the bodies of these snakes are cleared, and the killers get credit for the kill.
        // Snakes that are found to be able to move forward are advanced at the end of the step.
