...
public class Main {
  private static void printUsage() {
    System.out.println("Usage: java -jar dist/SnakeServer.jar [--server/-s server hostname]\n\t" +
      ...
      "[--map/-m map_filename] [--limit_ip/-l] [--disable_notifications/-n]\n\t" +
  ...
  public static void main(String[] args) {
    ...
    Integer intermission_duration = (Integer)parser.getOptionValue(intermission_duration_op,
      SnakeServer.DEFAULT_INTERMISSION_DURATION);
    Integer round_duration = (Integer)parser.getOptionValue(round_duration_op,
    ...
    if (max_rows != null && max_cols != null) {
      ...
      if (map_filename != null) {
        ...
        ss = new SnakeServer(max_rows.intValue(), max_cols.intValue(), num_ai.intValue(), map_filename,
          limit_connections_per_ip, disable_notifs, round_duration, intermission_duration);
      } else {
        ...
        ss = new SnakeServer(max_rows.intValue(), max_cols.intValue(), num_ai.intValue(), limit_connections_per_ip,
          disable_notifs, round_duration, intermission_duration);
      }
    } else {
      ...
      if (map_filename != null) {
        ...
        ss = new SnakeServer(num_ai.intValue(), map_filename, limit_connections_per_ip, disable_notifs,
          round_duration, intermission_duration);
      } else {
        System.out.println("Using default map file.");
